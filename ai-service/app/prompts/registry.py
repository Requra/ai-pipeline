...
class PromptId(str, Enum):
    ...
    REGENERATE_STORY_V1 = "regenerate_story_v1"
    REPAIR_STORIES_V1 = "repair_stories_v1"
...
PROMPT_MAP = {
    ...
    PromptId.REGENERATE_STORY_V1: "regenerate_story_v1.md",
    PromptId.REPAIR_STORIES_V1: "repair_stories_v1.md",
}
