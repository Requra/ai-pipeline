...
### 1. [Ingest Node (`ingest`)](nodes/01_ingest_guide.md)
...
### 2. [Transcribe Node (`transcribe`)](nodes/02_transcribe_guide.md)
...
### 3. [Extract Node (`extract`)](nodes/03_extract_guide.md)
...
### 4. [Classify Node (`classify`)](nodes/04_classify_guide.md)
...
### 5. [Generate Node (`generate`)](nodes/05_generate_guide.md)
...
### 6. [Summarize Node (`summarize`)](nodes/06_summarize_guide.md)
...
### 7. [Format Node (`format`)](nodes/07_format_guide.md)
